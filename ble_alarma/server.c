...
int main() {
    ...
    printf("  0x81 - Modo Total (GPIO 16)\n");
    printf("  0x82 - Modo Parcial (GPIO 18)\n");
    printf("  0x84 - Boton Panico (GPIO 20)\n");
    printf("  0x88 - Sirena (GPIO 21)\n");
    printf("  0x90 - Salida Aux (GPIO 12)\n");
